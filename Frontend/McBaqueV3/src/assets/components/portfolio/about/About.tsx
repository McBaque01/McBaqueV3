...
export const About = () => {
  return (
    <div
      id="About"
      className="relative flex h-fit w-full justify-center items-center overflow-hidden bg-clightbrown flex-col"
    >
      <div className="relative flex min-h-screen w-[80%] flex-col gap-2">
        ...
        <Fade>
          <FadeJr duration={0.3} direction="down" classname="relative flex h-[7.5em] w-full justify-center xl:h-[13em] xl:flex-row 2xl:h-[13em]">
        ...
        <div className="  relative flex h-fit w-full flex-col gap-2 py-4 xl:flex-row 2xl:flex-row">
          ...
          <Fade>
            <FadeJr direction="down" delay={0.3} classname="flex h-fit w-fit flex-col items-center  xl:h-full xl:min-w-[14em] 2xl:h-full 2xl:min-w-[14em]">
          ...
          <Fade>
          <FadeJr delay={0.6} direction="left" classname="h-full w-full py-4 xl:py-4 2xl:py-4">
            <p className="font-Montserrat text-[1em]  font-medium tracking-wider  text-cblue xl:text-[1.2em] xl:tracking-widest 2xl:text-[1.2em] 2xl:tracking-widest">
              Greetings, I am Mark John A. Baque a Web Developer utilizing MERN
              stack, developing user-friendly web applications that deliver
              seamless digital experience. I hold a Bachelor's degree on
              Information Technology and my continuous learning approach ensures
              that I am always ready to tackle new challenges and leverage
        ...
        <div className="  flex h-fit w-full flex-col items-center justify-center pb-[4em]">
          ...
          <Fade>
            <FadeJr delay={1.3} direction="left" classname="flex h-full w-full flex-col gap-1 pb-[4em] xl:flex-row 2xl:flex-row ">
              ...
              <div className=" h-full w-full py-4">
                ...
                <p className=" py-2 font-Montserrat text-[1em] font-medium tracking-wider text-cblue xl:text-[1.2em] 2xl:text-[1.2em]">
                  Capable of resolving software, hardware, and network issues for
                  colleagues while efficiently managing IT asset allocation and
                  maintenance. From unit receipt to database integration, I ensure
      ...
      <div className="absolute  bottom-0 w-full xl:h-[4em] 2xl:h-[4em] h-[3em] overflow-hidden">

          <img src={JapaneseWave} alt="JapaneseWabe" className="relative rotate-45 xl:-top-[36.7em] 2xl:-top-[42.4em] sm:top-[-15em] xl:left-[0em] 2xl:left-[10em] top-[-20em] min-w-[40em] max-w-[100em] w-full"></img>
      </div>

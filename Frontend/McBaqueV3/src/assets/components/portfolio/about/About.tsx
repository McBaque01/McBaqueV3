...
export const About = () => {
  return (
    <div
      id="About"
      className="relative flex h-fit w-full justify-center overflow-hidden bg-clightbrown"
    >
      <div className="relative flex min-h-screen w-[80%] flex-col gap-2">
        ...
        <div className="relative flex h-[7.5em] w-full justify-center xl:h-[13em] xl:flex-row 2xl:h-[13em]">
          <div className="relative top-[-7.5em] h-[15em] w-[15em] rounded-full border-2 border-black bg-cred transition-all duration-1000 xl:top-[-13em] xl:h-[26em] xl:w-[26em] 2xl:top-[-13em] 2xl:h-[26em] 2xl:w-[26em]"></div>
        </div>

        <div className="  relative flex h-fit w-full flex-col gap-2 py-4 xl:flex-row 2xl:flex-row">
          <div className=" flex h-fit w-fit flex-col items-center  xl:h-full xl:min-w-[14em] 2xl:h-full 2xl:min-w-[14em]">
          ...
          <div className="h-full w-full py-4 xl:py-4 2xl:py-4">
        ...
        <div className="  flex h-fit w-full flex-col items-center justify-center">
          ...
          <div className="  flex h-full w-full flex-col gap-1 pb-[4em] xl:flex-row 2xl:flex-row ">
